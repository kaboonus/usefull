...
namespace Sanderling.Parse
{
	...
	public class ModuleButtonTooltip : IModuleButtonTooltip
	{
		...
		static readonly string[] IsSalvagerSetIndicatorLabelRegexPattern = new string[]{
			@"Salvager",
		};
		static readonly string[] IsCloakerSetIndicatorLabelRegexPattern = new string[]{
			@"Cloaking",
		};
		static readonly string[] IsJammerSetIndicatorLabelRegexPattern = new string[]{
			@"Webifier",
			@"Disruptor",
			@"Scrambler",
		};
		static readonly string[] IsVampiricSetIndicatorLabelRegexPattern = new string[]{
			@"Nosferatu",
			@"Neutralizer",
		};
		static readonly string[] IsEnhangerSetIndicatorLabelRegexPattern = new string[]{
			@"Computer",
			@"Omnidirectional",
			@"Networked",
			@"Targeting",
		...
		static readonly string[] IsArmorRepairerSetIndicatorLabelRegexPattern = new string[]{
			@"Armor\s*Repair",
			@"Vestment\s*Reconstructer",
			@"Carapace\s*Restoration",
		};
		...
		public bool? IsSalvager { private set; get; }

		public bool? IsCloaker { private set; get; }

		public bool? IsJammer { private set; get; }

		public bool? IsVampiric { private set; get; }

		public bool? IsEnhanger { private set; get; }
		...
		public ModuleButtonTooltip(MemoryStruct.IContainer raw)
		{
			...
			IsMicroJumpDrive = LabelRegexMatchSuccessIgnoreCase(@"Micro\s*Jump\s*(Drive|Field)");
			...
			IsJammer = LabelAnyRegexMatchSuccessIgnoreCase(IsJammerSetIndicatorLabelRegexPattern);

			IsCloaker = LabelAnyRegexMatchSuccessIgnoreCase(IsCloakerSetIndicatorLabelRegexPattern);

			IsVampiric = LabelAnyRegexMatchSuccessIgnoreCase(IsVampiricSetIndicatorLabelRegexPattern);

			IsSalvager = LabelAnyRegexMatchSuccessIgnoreCase(IsSalvagerSetIndicatorLabelRegexPattern);

			IsEnhanger = LabelAnyRegexMatchSuccessIgnoreCase(IsEnhangerSetIndicatorLabelRegexPattern);
